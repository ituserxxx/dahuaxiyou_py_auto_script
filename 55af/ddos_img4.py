...
# 要上传的文件（替换为你的图片文件路径）
# file_path = 'goumai.jpg'
file_path = '2ljgggggg.jpg'
# file_path = 'i1234.png'
# file_path = 'info.php.jpg'
...
headers = {
    ...
    'Content-Type': 'multipart/form-data; boundary=----WebKitFormBoundaryhEgreI4dz5ENmZPG',
    # 注意：这个boundary通常是由requests库自动生成的，这里为了匹配你的要求手动设置，但在实际使用中应该让requests库处理
